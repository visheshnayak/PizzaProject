...
CREATE TABLE `orders` (
  ...
  `extraToppings` varchar(500) DEFAULT NULL,
  KEY `userid` (`userid`),
  KEY `pizzaid` (`pizzaid`),
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`),
  CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`pizzaid`) REFERENCES `pizza` (`pizzaid`)
...
CREATE TABLE `pizza` (
  ...
  `crust` varchar(250) DEFAULT NULL,
...
CREATE TABLE `toppings` (
  ...
  `topingname` varchar(100) DEFAULT NULL,
...
-- Dump completed on 2017-07-16 12:56:24
